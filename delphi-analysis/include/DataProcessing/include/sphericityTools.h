...
inline void Sphericity::calculateSphericity(int n, float *px, float *py, float *pz, Short_t *pwflag, int r){
  float norm = 0;
...
inline void Sphericity::setTree(eventData *e){ 
...
inline Sphericity::Sphericity(int n, float *px, float *py, float *pz, Short_t *pwflag, bool onlyCharged){
  l1 = -99;
  l2 = -99;
  l3 = -99;
  v1 = TVector3(0,0,0);
