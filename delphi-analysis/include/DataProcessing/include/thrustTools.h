...
inline void setThrustVariables(particleData *p, eventData *e, TVector3 thrust, 
...
inline TVector3 getThrustBelle(int n, float *px, float *py, float *pz,
                        bool doWeight=false,
...
inline TVector3 getSpecialThrustBelle(int n, float *px, float *py, float *pz, Short_t *pwflag, 
                              bool doCharged = true)
{
  std::vector<TVector3> momenta;
  for (int i = 0; i < n; ++i) {
...
inline TVector3 getThrustHerwig(int n, float *px, float *py, float *pz,
                        bool doWeight=false,
                        bool doInvertWeight=false,
                        float* weight=NULL,
                        bool doMET=false,
...
inline TVector3 getSpecialThrustHerwig(int n, float *px, float *py, float *pz, Short_t *pwflag, 
                                bool doCharged = true)
{
  float nTrk = 0;
  float pSum = 0;
...
inline TVector3 getThrust(int n, float *px, float *py, float *pz, THRUST::algorithm algo=THRUST::HERWIG, 
                  bool doWeight=false, 
                  bool doInvertWeight=false, 
                  float* weight=NULL, 
                  bool doMET=false, 
...
inline TVector3 getSpecialThrust(int n, float *px, float *py, float *pz, Short_t *pwflag, 
...
inline TVector3 getThrustMajor(TVector3 thrust, int n, float *px, float *py, float *pz, Short_t *pwflag, 
...
inline TVector3 getThrustMinor(TVector3 thrust, TVector3 thrustMajor, int n, float *px, float *py, float *pz, Short_t *pwflag, 
                        THRUST::algorithm algo=THRUST::HERWIG, bool doCharged=false)
{
  //check first that we are safely calling doCharged
  if(doCharged && pwflag == NULL){
