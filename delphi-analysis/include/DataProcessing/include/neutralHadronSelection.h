...
inline bool NeutralHadronSelection::highPurity(particleData * p, int indx){
...
inline void NeutralHadronSelection::fillHighPurity(particleData * p){
...
inline void NeutralHadronSelection::setAbsCosThCut(float cut){ absCosThCut = cut;}
inline void NeutralHadronSelection::setECut(float cut){ ECut = cut;}

inline NeutralHadronSelection::NeutralHadronSelection(){}
