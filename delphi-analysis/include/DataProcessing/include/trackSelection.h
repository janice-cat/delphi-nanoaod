...
inline bool TrackSelection::highPurity(particleData * p, int indx){
...
inline bool TrackSelection::highPurityBit(particleData * p, int indx){
  if(!(p->highPurity[indx])) return false;
  return true;
}


inline void TrackSelection::fillHighPurity(particleData * p){
...
inline void TrackSelection::setnTPCCut(Short_t cut){ nTPCcut = cut;}
inline void TrackSelection::setThetaCutLow(float cut){ thetaCutLow = cut;}
inline void TrackSelection::setThetaCutHigh(float cut){ thetaCutHigh = cut;}
inline void TrackSelection::setAbsCosThCut(float cut){ absCosThCut = cut;}
inline void TrackSelection::setPCut(float cut){ pCut = cut;}
inline void TrackSelection::setPtCut(float cut){ ptCut = cut;}
inline void TrackSelection::setD0Cut(float cut){ d0Cut = cut;}
inline void TrackSelection::setZ0Cut(float cut){ z0Cut = cut;}
...
inline bool TrackSelection::isConversionElectron(particleData * p, int indx){ 
...
inline TrackSelection::TrackSelection(){}
